...
export class ZcodeBackend extends Backend {
  ...
  onServerRequest(method, handler) {
    // Escape hatch for zcode-specific server-initiated requests that have no
    // Codex analog and carry no sessionId to rewrite (e.g.
    // session/requestRuntimePreferences, registered in bridge/index.js).
